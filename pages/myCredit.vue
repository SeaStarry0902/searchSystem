...
async function getCredit() {
    ...
    selectedProgram.value = userCredit.value.program.selected.code || 
                            userCredit.value.program.selected.program_code || userCredit.value.program.selected.name
    ...
    <div class=" w-full h-full overflow-auto">
        <div v-if="showInfo" class="flex flex-col w-[1200px] mx-auto gap-16 overflow-auto ">
            <div class="flex justify-between w-full">
                ...
                <div class="relative border bg-white w-80 h-64 rounded-lg flex flex-col items-center justify-center">
                    <div class="absolute top-1 right-2 text-[#3867DC] text-xl ">
                        ...
                        <select v-model="selectedProgram" v-if="select" class="cursor-pointer"
            ...
            <div class="flex justify-between w-full">
                ...
                <div
                    class="w-[400px] h-[347px] border rounded-lg bg-white flex flex-col items-center justify-center gap-6">
